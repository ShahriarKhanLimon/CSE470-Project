...
class UserManagerTests(TestCase):
    def test_create_user(self):
        user = User.objects._create_user('shahriarkhan530@gmail.com', '1234abcd')
...
class UserTests(TestCase):
    def setUp(self):
        self.user = User(email = "shahriarkhan530@gmail.com")

    def test__str__(self):
        self.assertEqual(self.user.__str__(), "shahriarkhan530@gmail.com")

    def test_get_full_name(self):
        self.assertEqual(self.user.get_full_name(), "shahriarkhan530@gmail.com")

    def test_get_short_name(self):
        self.assertEqual(self.user.get_short_name(), "shahriarkhan530@gmail.com")


class ProfileTests(TestCase):
    def setUp(self):
        self.profile = Profile(username="Shahriar", address_1="Mohakhali",zipcode="1212",city="Dhaka",country="Bangladesh")

    def test__str__(self):
        self.assertEqual(self.profile.__str__(), "Shahriar's Profile")
